...
torchrun --standalone --nnodes=1 --nproc-per-node=1 \
 main_runner.py --batch_size=4 --sw_batch_size=2 --epoch=1000 --mask_patch_size=16 --img_size=96 --loss_type=all_img --base_lr=1e-4 --min_lr=1e-5 --warmpup_epoch=4 --warmup_lr=1e-6 --cache_dataset --cache_rate=1 --model_type=swin_skip --save_freq=5 --print_freq=1 --log_dir="./output/swin_COMB_mm/logdir" --output="./output/swin_COMB_mm" --thread_loader --out_channels=1 --choice "all" --mm_con 0.03 --temperature 0.5
```